      ...
      <div className="w-full bg-white p-6">
        <div className="flex gap-10">
          <div className="w-1/2">
            ...
            <Roles addMode={addMode} selectedRole={selectedRole} setAddMode={setAddMode} setSelectedRole={setSelectedRole} setId={setId}/>
            </div>
          </div>
          <div className="w-1/2">
            <div className="flex flex-col gap-6">
              ...
              {!selectedRole ? (
                ...
                <Permission role={selectedRole} allowAll={allowAll} permissionValues={permissionValues} setPermissionValues={setPermissionValues} />
              )}
            </div>
          </div>
        </div>
