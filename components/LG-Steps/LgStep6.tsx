...
const LgStep6: React.FC<LgStepsProps3> = ({
  register,
  watch,
  setStepCompleted,
  setValue,
    ...
    >
      <div className="flex items-center gap-x-2 ml-3 mb-3">
        ...
        <p className="font-semibold text-[16px] text-lightGray">
          Name of any specific Banks in beneficiary country you want to issue
          the LG form, if no bank is chosen all banks in Beneficiary country
          will receive this request
        </p>
      </div>
      <div className="px-2 border border-[#E2E2EA] bg-[#F5F7F9] rounded-lg pb-2">
        <p className="py-2 font-semibold text-[#1A1A26] font-poppins px-2">
          Beneficiary Bank
        </p>
