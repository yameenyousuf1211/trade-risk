...
export default function NotificationPreferences() {
    ...
    const [allowNewRequestNotification, setAllowNewRequestNotification] = useState<boolean>(false);
    const [allowBidsNotification, setAllowBidsNotification] = useState<boolean>(false);
    ...
    const handleToggleChange = useCallback((toggleSetter: (value: boolean) => void, value: boolean) => {
        toggleSetter(value);
    }, []);
    ...
    return (
        <SettingLayout title='Notification preferences' subTitle='Manage contracts, countries, products, banks you have accounts with' hasButton active={5} handleSave={handleSave}>
